...
import { Users, Shield, FileText, Award, Calendar, Mail } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-black border border-blue-400 rounded-lg p-6">
              <div className="text-center mb-6">
                <h3 className="text-blue-400 text-xl font-bold px-4 py-2 border border-blue-400 rounded-lg inline-block">
                  STRUCTURE
                </h3>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-black border border-red-500 rounded-lg p-6">
              <div className="text-center mb-6">
                <h3 className="text-red-500 text-xl font-bold px-4 py-2 border border-red-500 rounded-lg inline-block">
                  BOARD OF DIRECTORS
                </h3>
              </div>
              <div className="text-white text-sm leading-relaxed space-y-4">
            ...
            <div className="bg-black border border-yellow-500 rounded-lg p-6">
              <div className="text-center mb-6">
                <h3 className="text-yellow-500 text-xl font-bold px-4 py-2 border border-yellow-500 rounded-lg inline-block">
                  EXECUTIVE BOARD
                </h3>
              </div>
              <div className="text-white text-sm leading-relaxed space-y-4">
